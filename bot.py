...
async def _handle_instagram(client, message, url, status, downloader, tmp_dir):
    ...
    try:
        ...
        elif content_info['type'] in ['story', 'story_mixed']:
            # История (смешанный тип - пробуем все файлы)
            for file_path in content_info['files']:
...
if __name__ == "__main__":
    ...
    logger.info("📸 Бот теперь поддерживает фото, карусели и истории Instagram (включая видео из историй)!")
